...
class PersonalInfoControllerTest < ActionController::TestCase
  setup do
    @personal_info = personal_info(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:personal_info)
  end
  ...
  test "should update personal_info" do
    put :update, id: @personal_info, personal_info: {  }
    assert_redirected_to personal_info_path(assigns(:personal_info))
  end
  ...
  test "should destroy personal_info" do
    ...
    assert_redirected_to personal_info_index_path
  end
end
